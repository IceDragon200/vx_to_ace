...
//      
//   CleverClassEquip=0 (Currently disabled, and uncoded)
//     This would try to create weapon_types based on a sorting and grouping algorithim.
//     Currently this is not implemented, and therefore not available.
//
// General
